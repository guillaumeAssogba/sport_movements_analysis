...
def launchProcess(self):
    ...
    var1_reduced, var1_components = pca.applyPCA(varMatrices[0])
    var2_reduced, var2_components = pca.applyPCA(varMatrices[1])
    var3_reduced, var3_components = pca.applyPCA(varMatrices[2])
    
    #Represent the score for each PCs
    pltVar.PCArepresentation(var1_reduced, "1", meanMatrices[0], time)
    pltVar.PCArepresentation(var2_reduced, "2", meanMatrices[1], time)
    pltVar.PCArepresentation(var3_reduced, "3", meanMatrices[2], time)
